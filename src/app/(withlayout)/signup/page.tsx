...
export default function Signup() {
    ...
    return (
        <div className="mx-auto p-4 m-4 w-full max-w-sm overflow-hidden rounded-lg border bg-white dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div className="w-full flex-col items-center overflow-hidden p-4 sm:p-8">
                ...
                <div className="mt-3 space-y-3 sm:space-y-5">
                    ...
                    <button
                        // onClick={}
                        className="mx-auto mb-4 mt-8 block rounded-md border px-5 py-2 shadow-lg duration-200 hover:bg-zinc-400/10 dark:border-zinc-700 dark:hover:bg-zinc-700 dark:hover:text-white"
                    >
